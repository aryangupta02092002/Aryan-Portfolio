...
const experience = [
    {
        ...
        description3: "Fixed issues occurred due to ECC to S/4 HANA Migration",
        description4: "Optimized and modernized custom ABAP code for compatibility with S/4 HANA, enhancing overall performance and processing speed",
        description5: "Received appreciation for independently delivering high-quality technical solutions that ensured timely project success",
